...
<div class='absolute flex flex-col bg-gradient-to-r from-green-900 to-green-800 h-screen w-screen justify-center items-center '>
    ...
    <main class=' container flex flex-col items-center space-y-20 bg-white w-[600px] h-[550px] rounded-2xl shadow-2xl py-6'>
        ...
        <% } %>
        <form action="SignUpCan" method="post" class='h-full flex flex-grow flex-col justify-evenly items-center'>
            ...
            <div class='flex items-center justify-between py-2 focus:border-gray-800 w-5/6 border-b border-gray-400'>
                <input type='password' name='password2' id="password2" required placeholder='Confirm password' class='font-niramit text-xl outline-none ' />
            ...
            <input type='text' name='telephone' required placeholder='Phone number' class='w-5/6 font-niramit text-xl border-b border-gray-400 outline-none py-2 focus:border-gray-800' />
            <input type='text' name='formation' required placeholder='Formation' class='w-5/6 font-niramit text-xl border-b border-gray-400 outline-none py-2 focus:border-gray-800' />
